...
export class global_settings_CRM {
  static #projectName = 'Gold Cash';
  static #projectTagline = 'CRM Panel';
  static #projectIcon = 'goldCash-logo.svg';
  static #projectFavicon = 'goldCash-logo.svg';
  ...
  static set projectIcon(val) {
    this.#projectIcon = val || 'goldCash-logo.svg';
    if (!this.#projectFavicon || this.#projectFavicon === 'goldCash-logo.svg') {
